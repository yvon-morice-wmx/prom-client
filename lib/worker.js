...
const ANNOUNCEMENT = '@prometheus/client_js:announcement';
const GET_METRICS_REQ = '@prometheus/client_js:getMetricsReq';
const GET_METRICS_RES = '@prometheus/client_js:getMetricsRes';
const ANNOUNCEMENT_CHANNEL = new BroadcastChannel(
	'@prometheus/client_js:announce',
);
...
function addListeners(registry) {
	...
	const name = `@prometheus/client_js:worker:${threadId}`;
	const channel = new BroadcastChannel(name);
