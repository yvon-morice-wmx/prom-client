...
const benchmarks = new Benchmark({
	'@prometheus/client_js@latest': '@prometheus/client_js@latest',
	'@prometheus/client_js@trunk': 'git@github.com:prometheus/client_js',
	'@prometheus/client_js@current': { location: process.cwd() },
});
